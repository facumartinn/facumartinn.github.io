        ...
        return (
            <div className=" z-10 w-full fixed bottom-0 flex flex-row justify-center content-center mb-2">
                ...
                <Spring from={{opacity: 0, x:100}} to={{opacity:1, x:0}} config={{delay: 1400}}>
                    ...
                    <Spring from={{opacity: 0, x:100}} to={{opacity:1, x:0}} config={{delay: 1600}}>
                        {props => (
                            <div style={props}>
                    ...
                    <Spring from={{opacity: 0, x:100}} to={{opacity:1, x:0}} config={{delay: 1800}}>
                        {props => (
                            <div style={props}>
                    ...
                    <Spring from={{opacity: 0, x:100}} to={{opacity:1, x:0}} config={{delay: 2000}}>
                        {props => (
                            <div style={props}>
